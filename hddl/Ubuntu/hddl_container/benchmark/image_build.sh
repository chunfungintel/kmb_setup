...
wget $WGET_TAG  $HOST_PACKAGE_LINK/$OPENVINO_PACKAGE_NAME -P $HDDL_RESOURCE_FOLDER

rm -rf $HDDL_RESOURCE_FOLDER/$DEB_PACKAGE_NAME
wget $WGET_TAG  $HOST_PACKAGE_LINK/host_packages/$DEB_PACKAGE_NAME -P $HDDL_RESOURCE_FOLDER
