...
cd /data/avc_uncontained_woBframe; gst-launch-1.0 multifilesrc location="%02d.h264" index=11 stop-index=20 ! h264parse ! vaapih264dec ! "video/x-raw(memory:DMABuf)" \
